...
function WalletCard({ wallet, index }: { wallet: Account; index: number }) {
      ...
      >
        ...
        <View className="flex-row items-start justify-between mb-3">
          <View className="flex-1">
            <View className="flex-row items-center">
              ...
              {wallet.isDefault && (
                <View className="ml-2 px-2 py-0.5 rounded-full" style={{ backgroundColor: 'rgba(196, 181, 253, 0.2)' }}>
                  <Star size={12} color="#C4B5FD" fill="#C4B5FD" />
                </View>
              )}
            </View>
        ...
        <View className="pt-3 border-t" style={{ borderTopColor: '#F3F4F6' }}>
          ...
          <Text
            ...
            style={{ color: wallet.balance >= 0 ? '#006A6A' : '#DC2626' }}
          >
          ...
          <Animated.View entering={FadeInDown.duration(600)} className="mx-6 mb-6">
            ...
            >
              ...
              <Text className="text-3xl font-bold text-white mb-1">
                {formatBalance(totalBalance, defaultWallet?.currency || 'CHF')}
              </Text>
