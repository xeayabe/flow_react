    ...
    >
      ...
      <Pressable
        ...
        style={{
          ...
          height: 64,
          borderRadius: 32,
          // FIX: TASK-3 - Already uses colors.contextTeal, verified
          backgroundColor: colors.contextTeal,
          // FIX: TASK-3 - Already uses colors.sageGreen, verified
      ...
      >
        <View
          style={{
            ...
            borderRadius: 32,
            borderWidth: 2,
            // FIX: TASK-3 - Already uses colors.borderSage, verified
